...
<template>
  <Pill color="secondary" :text="props.rusName" v-if="props.name == OrderStatusEnum.CREATED"/>
  <Pill color="secondary" :text="props.rusName" v-if="props.name == OrderStatusEnum.WAITING"/>
